...
export default function ManiPediPage() {
  const ManiPediImages = [
    { src: '/menicure.jpg', alt: 'Manicure' },
    { src: '/pedicure.jpg', alt: 'Pedicure' }
  ];

  return (
    <div className="min-h-screen bg-gradient-to-r from-purple-500 to-pink-400 flex flex-col mb-4 p-4">
      <h1 className="text-3xl font-bold mb-8 text-center">Mani & Pedi Services</h1>
      <div className="grid grid-cols-1 gap-6">
        {ManiPediImages.map((image, index) => (
